    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrador'), ('estandar', 'Estandar')], max_length=50, verbose_name='Rol')),
                ('is_staff', models.BooleanField(default=False, verbose_name='¿Es miembro del staff?')),
                ('is_active', models.BooleanField(default=False)),
                ('coderegistro', models.CharField(blank=True, max_length=10, null=True, verbose_name='Código de registro')),
